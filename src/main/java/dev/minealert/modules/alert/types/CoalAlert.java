...
@ModuleInfo(moduleName = "Coal Alert",
        moduleDesc = "Coal Alert for Alert Components",
        abstractFile = OreSettingsFile.class)
public class CoalAlert extends AbstractAlertModule {
    ...
    public void callInit(Player player) {
        init(mineMap, player, "alert.coal-enable","alert.coal-amount", Lang.COAL_ALERT_MESSAGE, false);
    }
    ...
    public String update() {
        return "UPDATE MINEDATA SET COAL=? WHERE UUID=?";
    }
